...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/seleccionar-rol" element={user ? <RoleSelector /> : <Navigate to="/login" />} />
      ...
      <Route path="/centros" element={<ProtectedRoute roles={['admin','gestor','asesor']}><Centros /></ProtectedRoute>} />
      <Route path="/usuarios" element={<ProtectedRoute roles={['admin']}><Usuarios /></ProtectedRoute>} />
      <Route path="/docentes" element={<ProtectedRoute roles={['admin','gestor','coordinador','asesor']}><Docentes /></ProtectedRoute>} />
      <Route path="/alumnos" element={<ProtectedRoute roles={['admin','gestor','coordinador','asesor','docente']}><Alumnos /></ProtectedRoute>} />
